...
describe('limit fields', () => {
  it('should return order with only 2 selected fields: test_string and test_any', async () => {
    const { body } = await request(app)
      .get(`/api/orders?fields=test_string,test_any`)
      .set('Cookie', cookie)
      .expect(200);
  ...
  it('should return all fields except for excluded field', async () => {
    const { body } = await request(app)
      .get(`/api/orders?fields=-test_any`)
      .set('Cookie', cookie)
      .expect(200);
...
describe('itemPerPage & page', () => {
  it('should return 2 orders with ?itemsPerPage=2&page=1', async () => {
    const response = await request(app)
      .get('/api/orders?itemsPerPage=2&page=1')
      .set('Cookie', cookie)
      .expect(200);
  ...
  it('should returns single order with itemsPerPage=2 and page=2', async () => {
    const response = await request(app)
      .get('/api/orders?itemsPerPage=2&page=2')
      .set('Cookie', cookie)
      .expect(200);
...
describe('sorting', () => {
  it('should sort by number from high to low', async () => {
    const { body } = await request(app)
      .get('/api/orders?sort=-test_number')
      .set('Cookie', cookie)
      .expect(200);
  ...
  it('should sort by text from a-z', async () => {
    const { body } = await request(app)
      .get('/api/orders?sort=test_string')
      .set('Cookie', cookie)
      .expect(200);
...
describe('gt, gte, lt,lte', () => {
  it('return orders that has test_number < 13', async () => {
    const { body } = await request(app)
      .get('/api/orders?test_number[lt]=13')
      .set('Cookie', cookie)
      .expect(200);
  ...
  it('return orders that has test_number <= 13', async () => {
    const { body } = await request(app)
      .get('/api/orders?test_number[lte]=13')
      .set('Cookie', cookie)
      .expect(200);
  ...
  it('return orders that has test_number > 12', async () => {
    const { body } = await request(app)
      .get('/api/orders?test_number[gt]=12')
      .set('Cookie', cookie)
      .expect(200);
  ...
  it('return orders that has test_number >= 12', async () => {
    const { body } = await request(app)
      .get('/api/orders?test_number[gte]=12')
      .set('Cookie', cookie)
      .expect(200);
...
describe('filter by value', () => {
  it('returns orders has test_number equal to 11 or 14', async () => {
    const { body } = await request(app)
      .get('/api/orders?test_number=11,14&sort=test_number')
      .set('Cookie', cookie)
      .expect(200);
  ...
  it('returns orders has test_number equal to 11 or 14 but inputed as hpp polution', async () => {
    const { body } = await request(app)
      .get('/api/orders?test_number=11&sort=test_number&test_number=14')
      .set('Cookie', cookie)
      .expect(200);
