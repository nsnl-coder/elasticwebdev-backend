...
it('should return error if deleteList is non-existent ObjectId', async () => {
  ...
  expect(response.body.message).toEqual('Can not find products with provided ids');
});

it('should delete products if deleteList contains at least an existent objectid', async () => {
